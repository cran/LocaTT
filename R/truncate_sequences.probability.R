...
#' @param threshold Numeric. The probability threshold used for truncation. The default is `0.5` (*i.e.*, each truncated sequence has a greater than 50% probability that all bases were called correctly).
